    ...
    <div className="text-center">
      ...
      >
        <div className="relative w-96 h-96 mx-auto">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center z-20">
            ...
            <motion.div 
              className={`text-xl font-semibold px-6 py-2 rounded-full backdrop-blur-sm border ${
                isBreak 
      ...
      >
        <motion.button
          ...
          className={`w-20 h-20 rounded-2xl flex items-center justify-center text-white shadow-2xl backdrop-blur-sm border transition-all duration-300 ${
            isActive 
        ...
        <motion.button
          onClick={resetTimer}
          className="w-20 h-20 rounded-2xl bg-gradient-to-br from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 flex items-center justify-center text-white shadow-2xl backdrop-blur-sm border border-gray-500/30"
          whileHover={{ 
            scale: 1.1,
            boxShadow: "0 25px 50px -12px rgba(0, 0, 0, 0.25)"
          }}
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <span className="text-white font-semibold text-lg">Pomodoro Oturumları</span>
              <p className="text-white/60 text-sm">Günlük hedefinize ulaşın</p>
            </div>
          </div>
          <div className="text-right">
            <span className="text-2xl font-bold text-white">{completedPomodoros}/4</span>
